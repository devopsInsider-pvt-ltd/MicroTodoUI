...
const GET_TASKS_API_BASE_URL = "http://get-tasks-api.sandydevops.shop";
const DELETE_TASK_API_BASE_URL = "http://delete-task-api.sandydevops.shop";
const CREATE_TASK_API_BASE_URL = "http://add-task-api.sandydevops.shop";
